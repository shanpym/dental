...
<body>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          ...
          <div class="navbar-collapse" id="">
            <div class="d-none d-lg-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item">
                  <a href="login.php" class="nav-link" href="fruit.html">
                    <img src="images/login.png" alt="" />
                    <span>Login</span></a>
                </li>
                <li class="nav-item">
                  <a href="signup.php"  class="nav-link" href="service.html">
            ...
            <div id="myNav" class="overlay">
              <div class="overlay-content">
                ...
                <a href="portfolio.php">PROCEDURES</a>
            ...
            <div class="row">
              <div class="col-md-3 offset-md-2">
                <div class="slider_detail">
                  ...
                  <p>
                  Extensive dental expertise, truly state-of-the-art, and the best locations in Metro Manila.
                  </p>
                  <div>
              ...
              <div class="col-md-7">
                <div class="slider_img-box" >
                  <img src="img/slider-1.jpg" style="width: 80%;" alt="">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-3 offset-md-2">
                <div class="slider_detail">
                  ...
                  <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed explicabo, laudantium consequuntur suscipit 
                  </p>
                  <div>
                    <a href="">
                      Read More
              ...
              <div class="col-md-7">
                <div class="slider_img-box">
                <img src="img/slider-2.jpg" style="width: 80%;" alt="">
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="Why_section layout_padding">
    <div class="container">
      ...
      <div class="about_card-container" >
        <div class="about_card " >
          <div class="about-detail bg-primary" style="border-radius: 200px !important; height: 350px !important">
            <div class="p-5">
            <h4 class="text-light">
                Step 1
              </h4>
